...
const snakescorePlayingCategorySchema = new mongoose.Schema({
...
{
    timestamps: true,
    collection:'snake_score'
 }


);

const snakescore = mongoose.model('snakescore', snakescorePlayingCategorySchema);
