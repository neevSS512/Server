...
const snakecountergameSchema = new mongoose.Schema({
...
{
    timestamps: true,
    collection:'snake_counter'
  }
);

const snakecounterGame = mongoose.model('snakecounterGame', snakecountergameSchema);

module.exports = snakecounterGame;
